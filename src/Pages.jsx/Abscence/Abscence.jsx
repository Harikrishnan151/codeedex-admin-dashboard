...
function Abscence() {
  return (
    <div className='container'>
      <h3 style={{color:'black'}} className='mx-4 mt-4 '>Absence</h3>
      <p className='mx-4' style={{ color: '#4F4F4F' }}>Analyse / <span style={{ color: 'black', }}>Absence</span></p>
      <div className="row row1 mx-4">
        <div className="col-12 my-3">
          <h5 style={{ fontWeight: "bold" }}>Absence Record</h5>
          <MDBTable responsive >
