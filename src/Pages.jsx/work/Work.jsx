    ...
    return (
        <div className="container">
            <div className='row workRow1'>
                <div className="col-6">
                    <h3 style={{color:'black'}} className='mx-4 mt-4 '>Works</h3>
                    <p className='mx-4' style={{ color: '#4F4F4F' }}>Manage / <span style={{ color: 'black', }}>Work</span></p>
            ...
            <div className="row row1 mx-2 my-2">
                <div className="col-12 my-3 headingRow2">
                    <h5 style={{ fontWeight: "bold",color:"black" }}>Current Works</h5>
                    <div>
