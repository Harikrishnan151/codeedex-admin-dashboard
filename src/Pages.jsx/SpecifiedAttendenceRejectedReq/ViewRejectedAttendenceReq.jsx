...
import './ViewRejectedAttendenceReq.css'
...
function ViewRejectedAttendenceReq() {
  ...
  return (
    ...
    <h3 style={{ color: 'black' }} className='main-Headings mx-4 mt-4 '>Rejected Request</h3>
    <p className='main-Headings mx-4' style={{ color: '#4F4F4F' }}>Manage / Attendence / <span style={{ color: 'black', }}>View Rejected Request</span></p>
    </div>
    <div className="row  mx-2 adminRow">
    <h5 className='mainHeading my-3' style={{ fontWeight: "bold",color:'black' }}>View Rejected Request</h5>
...
export default ViewRejectedAttendenceReq